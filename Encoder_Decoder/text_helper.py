...
def text_to_numbers(sentences, word_dict, language='en', ensure=None):
...
def load_data(folder_name='G:\python\DeepLearning\Learning_NLP\\temp\cn_nlp\corpus\\translate\Bilingual'):
    dirs = []
    en_data = []
    en_len = []
    cn_data = []
...
def load_test_data(folder_name=
                   'G:\python\DeepLearning\Learning_NLP\\temp\cn_nlp\corpus\\translate\Testing\Testing-Data.txt'):
    en_data = []
    en_len = []
    cn_data = []
    cn_len = []
